...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1>停 车 场</h1>
            <button><a href="${APP_PATH}/CarList" style="font-size: 20px;text-decoration: none;font-family: Calibri">查看公告</a>
            </button>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function build_emps_table1(result) {
        ...
        $.each(emps, function (index, item) {
            ...
            var editBtn1 = $("").addClass("btn btn-primary btn-sm edit_btn")
